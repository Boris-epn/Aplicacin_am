...
class SlotSelectionActivity : AppCompatActivity() {
    ...
    private fun bindSlots() {
        ...
        val slots = listOf(
            Slot(firstDate, "10:30"), Slot(firstDate, "11:30"), Slot(firstDate, "15:00"),
            Slot(secondDate, "09:00"), Slot(secondDate, "14:00")
        )
        ...
        slots.forEachIndexed { index, slot ->
            ...
            findViewById<CardView>(cardIds[index]).setOnClickListener {
                selectSlot(slot, index, cardIds, dateIds, timeIds, statusIds)
            }
        }
        selectSlot(slots.first(), 0, cardIds, dateIds, timeIds, statusIds)
    }
    ...
    private fun createAppointment() {
        ...
        lifecycleScope.launch {
            ...
            if (occupied) {
                Toast.makeText(this@SlotSelectionActivity, "Ese horario ya fue ocupado", Toast.LENGTH_SHORT).show()
                return@launch
            }
